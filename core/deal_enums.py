...
class SpecialBid(Enum):
    ...
    __from_str_map__ = {'PASS': PASS, 'X': DOUBLE, 'XX': REDOUBLE}

    @classmethod
    def from_str(cls, bidding_suit_str: str) -> SpecialBid:
        return SpecialBid(cls.__from_str_map__[bidding_suit_str.upper()])
